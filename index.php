    ...
    <div class="main-part" id="content" style="min-height: 600px;" >
        ...
        <section id="reach-to" class="welcome-part home-icon">
			<div class="row" style="
					...
					z-index: 111;
					text-align: center;
					padding: 20px 0 0 5px; margin-right:0;margin-left:0;">
			 
			 <a  href=" https://www.ubereats.com/ke/store/road-house-grill/rXbzh14DSYCdnEFLVxYb2w"  class="button-white" style="display: inline-block !important;border: 1px solid #ffffff !important;padding: 4px 5px !important;border-radius: 4px !important; background-color: #fff; width:110px !important" ><img src="images/tripadvisor.png" /></a>
			</div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" >
                                ...
                                <div class="service-track-overlay banner-bg" style="background-color: #f6871e" onclick="pickup_order()">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" id="groupOrder">
                                ...
                                <div class="service-track-overlay banner-bg" onclick="delivery_order()" style="background-color: #f6871e">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" >
                                ...
                                <div class="service-track-overlay banner-bg" style="background-color: #f6871e" onclick="group_order()">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                                    <h3>Group <span>Order</span></h3>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" id="groupOrder">
                                ...
                                <div class="service-track-overlay banner-bg" onclick="catering()" style="background-color: #f6871e">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                                    <h3>Catering <span>Service</span></h3>
