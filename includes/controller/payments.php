...
//$orderConfirm->afterPayment('RH082004861');
//$orderConfirm->afterPayment('RH082004737');
...
if (!isset($_POST["txn_id"]) && !isset($_POST["txn_type"])) {
    ...
    else if (strpos($item_name, 'RHG') !== false) {
        $paypalConfig = [
            'email' => $enableSandbox ? $paypal_sandbox : $paypal_email,
            'return_url' => $next_url,
            'cancel_url' => $project_url.'account',
    ...
    //$orderConfirm->afterPayment('RH082004862');
    ...
    //$orderConfirm->afterPayment('RH082004864');
