...
use Kabangi\Mpesa\Validation\ValidatorInterface;
...
class Validator implements ValidatorInterface
{
     ...
     *
     * @var \Kabangi\Mpesa\Validation\DataWrapper\WrapperInterface
     */
    ...
    public function remove($selector, $name = true, $options = null)
    {
        ...
        /* @var $collection \Kabangi\Mpesa\Validation\ValueValidator */
     ...
     * @param mixed $data
     *
     * @return \Kabangi\Mpesa\Validation\DataWrapper\WrapperInterface
     */
    ...
    public function validate($data = null)
    {
        ...
        foreach ($this->rules as $selector => $valueValidator) {
            foreach ($this->getDataWrapper()->getItemsBySelector($selector) as $valueIdentifier => $value) {
                /* @var $valueValidator \Kabangi\Mpesa\Validation\ValueValidator */
