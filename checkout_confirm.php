        ...
        <section class="home-icon shop-cart bg-skeen wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
            ...
            <div class="container">
                ...
                <div class="order-complete-box">
                    ...
                    <a href="#" class="btn-medium btn-primary-gold" id="tracker">Go To Food Tracker</a>
					<br /><br />
                    <button type="button" class="btn btn-success"  onclick="makePayment()" id="resubmit">Resubmit Payment</button>
                    <br /><br />
                    ...
                    $.each(data.records, function(i,data){
						...
						if(data.mpesa==1){
							...
							if(order_no != "" && order_no !== undefined){
								let order_type 	= (order_no.substring(3, 0)=='RHG')?2:1;
